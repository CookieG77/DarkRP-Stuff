...
public class MethCrateFullBlock extends DarkrpStuffModElements.ModElement {
	@ObjectHolder("darkrp_stuff:meth_crate_full")
	public static final Block block = null;

	public MethCrateFullBlock(DarkrpStuffModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("meth_crate_full");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A78Pleine"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MethCrateFullBlock.block));
		}
	}
}
