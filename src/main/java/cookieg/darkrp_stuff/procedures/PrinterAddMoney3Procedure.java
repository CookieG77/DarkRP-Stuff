...
public class PrinterAddMoney3Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (Math.floor(DarkrpStuffModVariables.MapVariables.get(world).printer3 / 20) == DarkrpStuffModVariables.MapVariables.get(world).printer3
				/ 20) {
		...
		if (DarkrpStuffModVariables.MapVariables.get(world).printer3 >= 300 && new Object() {
