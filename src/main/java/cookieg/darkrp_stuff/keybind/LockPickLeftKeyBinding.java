...
import cookieg.darkrp_stuff.procedures.LockPickLeftToucheEnfonceeProcedure;
...
public class LockPickLeftKeyBinding extends DarkrpStuffModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public LockPickLeftKeyBinding(DarkrpStuffModElements instance) {
		super(instance, 73);
	...
	public void initElements() {
		keys = new KeyBinding("key.darkrp_stuff.lock_pick_left", GLFW.GLFW_KEY_A, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			LockPickLeftToucheEnfonceeProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
