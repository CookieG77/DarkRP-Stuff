...
import cookieg.darkrp_stuff.procedures.LockPickRightToucheEnfonceeProcedure;
...
public class LockPickRightKeyBinding extends DarkrpStuffModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public LockPickRightKeyBinding(DarkrpStuffModElements instance) {
		super(instance, 74);
	...
	public void initElements() {
		keys = new KeyBinding("key.darkrp_stuff.lock_pick_right", GLFW.GLFW_KEY_D, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			LockPickRightToucheEnfonceeProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
