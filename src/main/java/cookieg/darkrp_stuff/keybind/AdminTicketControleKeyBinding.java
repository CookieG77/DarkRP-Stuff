...
import cookieg.darkrp_stuff.procedures.OpenAdminTicketWindowProcedure;
...
public class AdminTicketControleKeyBinding extends DarkrpStuffModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public AdminTicketControleKeyBinding(DarkrpStuffModElements instance) {
		super(instance, 141);
	...
	public void initElements() {
		keys = new KeyBinding("key.darkrp_stuff.admin_ticket_controle", GLFW.GLFW_KEY_0, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenAdminTicketWindowProcedure.executeProcedure(Stream
