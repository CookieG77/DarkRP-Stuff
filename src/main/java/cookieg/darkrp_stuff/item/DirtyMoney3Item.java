...
public class DirtyMoney3Item extends DarkrpStuffModElements.ModElement {
	@ObjectHolder("darkrp_stuff:dirty_money_3")
	public static final Item block = null;

	public DirtyMoney3Item(DarkrpStuffModElements instance) {
		super(instance, 24);
	}
