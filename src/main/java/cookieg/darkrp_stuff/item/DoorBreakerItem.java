...
import cookieg.darkrp_stuff.procedures.ClickDroitPorteBelierProcedure;
...
public class DoorBreakerItem extends DarkrpStuffModElements.ModElement {
	@ObjectHolder("darkrp_stuff:door_breaker")
	public static final Item block = null;

	public DoorBreakerItem(DarkrpStuffModElements instance) {
		super(instance, 130);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Pour les forces de police uniquement"));
		}
