...
import cookieg.darkrp_stuff.gui.WalletGUIGuiWindow;
import cookieg.darkrp_stuff.gui.WalletGUIGui;
import cookieg.darkrp_stuff.DarkrpStuffModElements;

@DarkrpStuffModElements.ModElement.Tag
public class WalletItem extends DarkrpStuffModElements.ModElement {
	@ObjectHolder("darkrp_stuff:wallet")
	public static final Item block = null;

	public WalletItem(DarkrpStuffModElements instance) {
		super(instance, 165);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof WalletGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Pour ranger vos papiers d'identit\u00E9"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Portefeuille");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new WalletGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
