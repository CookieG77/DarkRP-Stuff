...
public class DirtyMoney2Item extends DarkrpStuffModElements.ModElement {
	@ObjectHolder("darkrp_stuff:dirty_money_2")
	public static final Item block = null;

	public DirtyMoney2Item(DarkrpStuffModElements instance) {
		super(instance, 23);
	}
