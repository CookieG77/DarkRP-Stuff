...
import cookieg.darkrp_stuff.procedures.OpenWriteMenuWeaponLicenseProcedure;
...
public class WeaponCardEmptyItem extends DarkrpStuffModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(DarkRPStuffItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			OpenWriteMenuWeaponLicenseProcedure.executeProcedure(Stream
