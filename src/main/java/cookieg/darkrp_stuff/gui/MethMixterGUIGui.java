...
import cookieg.darkrp_stuff.procedures.MethMixterGUIPendantQueCeGUIEstOuvertParTickProcedure;
...
public class MethMixterGUIGui extends DarkrpStuffModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MethMixterGUIGui(DarkrpStuffModElements instance) {
		super(instance, 41);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("meth_mixter_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, MethMixterGUIGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			MethMixterGUIPendantQueCeGUIEstOuvertParTickProcedure
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 23, 57) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (SmokeFilterItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 95, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (PlateItem.block == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			MethMixerStartMixingProcedure.executeProcedure(Stream
