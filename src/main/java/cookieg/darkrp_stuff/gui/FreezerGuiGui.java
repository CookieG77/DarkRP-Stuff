...
public class FreezerGuiGui extends DarkrpStuffModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public FreezerGuiGui(DarkrpStuffModElements instance) {
		super(instance, 34);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("freezer_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FreezerGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 25, 23) {
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 61, 23) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 97, 23) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 133, 23) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
