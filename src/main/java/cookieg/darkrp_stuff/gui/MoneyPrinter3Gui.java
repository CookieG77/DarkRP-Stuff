...
public class MoneyPrinter3Gui extends DarkrpStuffModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MoneyPrinter3Gui(DarkrpStuffModElements instance) {
		super(instance, 27);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("money_printer_3"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, MoneyPrinter3GuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 61, 37) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (Items.INK_SAC == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 114, 37) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
