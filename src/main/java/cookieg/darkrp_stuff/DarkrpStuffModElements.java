...
public class DarkrpStuffModElements {
	...
	public DarkrpStuffModElements() {
		sounds.put(new ResourceLocation("darkrp_stuff", "moneyclick"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("darkrp_stuff", "moneyclick")));
		sounds.put(new ResourceLocation("darkrp_stuff", "fan"), new net.minecraft.util.SoundEvent(new ResourceLocation("darkrp_stuff", "fan")));
		sounds.put(new ResourceLocation("darkrp_stuff", "methmixer_nofilter"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == DarkrpStuffModElements.ModElement.class)
						elements.add((DarkrpStuffModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(DarkrpStuffModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new DarkrpStuffModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		DarkrpStuffMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final DarkrpStuffModElements elements;
		protected final int sortid;

		public ModElement(DarkrpStuffModElements elements, int sortid) {
